...
export const DAILY_MESSAGES: { title: string; body: string }[] = [
  { title: 'C’est l’heure.', body: '{hour}. C’est l’heure où tu flanches d’habitude. Pas ce soir.' },
  ...
  { title: 'Ta streak grandit.', body: 'Elle dort peut-être. Toi, tu te reconstruis. Ce n’est pas la même nuit.' },
  ...
  { title: 'Fais le test.', body: 'Envie de lui écrire ? Le crash test est là pour ça. Ta streak reste intacte.' },
...
export const MILESTONES: { day: number; title: string; body: string }[] = [
  ...
  { day: 7, title: 'Une semaine.', body: '7 jours sans contact. Ta carte est prête — montre-la ou garde-la pour toi.' },
